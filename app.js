document.addEventListener("DOMContentLoaded", async () => {
  ...
  const timeElapse = () => {
    ...
    const startDate = new Date("2024-08-01T00:00:00"); // August 1, 2024
    let seconds = (current - startDate) / 1000;
    ...
    const result = `<span class="digit">${days}</span> Days <span class="digit">${hours}</span> Hours <span class="digit">${minutes}</span> Mins <span class="digit">${seconds}</span> Secs`;
